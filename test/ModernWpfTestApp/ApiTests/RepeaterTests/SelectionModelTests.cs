...
using SelectionModelSelectionChangedEventArgs = ModernWpf.Controls.SelectionModelSelectionChangedEventArgs;
using SelectionModelChildrenRequestedEventArgs = ModernWpf.Controls.SelectionModelChildrenRequestedEventArgs;
